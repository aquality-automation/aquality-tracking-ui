...
export class PrintMilestoneComponent extends ModalComponent implements OnInit {
    ...
    addMilestoneInfo() {
        const height = 37;
        const textsize = 40;
        if (this.milestone) { this.doc.text(95, height + 10, this.cutText(this.milestone.name, textsize)); }
        if (this.milestone) { this.doc.text(75, height + 10, 'Milestone:'); }
    }
